    ...
    public class UploadPOToPOMWorkflow
    {
        ...
        public static UploadPOToPOMPage UploadPOMFile(IWebDriver driver, string fileType = null)
        {
            ...
            else
            {
                ...
                process = Process.Start(Path.Combine(new DirectoryInfo(System.IO.Directory.GetCurrentDirectory()).Parent.Parent.Parent.FullName,@"DSA\Utils\AutoItScripts\UploadPomFileParam.exe"), uploadPOToPOMPage.GeneratePOMFile(fileType));
