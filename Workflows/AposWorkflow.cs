...
namespace Dsa.Workflows
{
    ...
    public class AposWorkflow
    {
        ...
        public  ServiceTagSearchResultPage SearchForServiceTags(IWebDriver driver, string serviceTag, Catalogs catalog = Catalogs.SmallBusiness)
        {
            ...
            var serviceTagearch = new ServiceTagSearchPage(driver);
            serviceTagearch.ServiceTagTxt.SetText(driver, serviceTag);
        ...
        {
            new ServiceTagSearchPage(driver).SelectCatalog(catalog);
            var serviceTagearchusingcustomerno = new ServiceTagSearchPage(driver);
            serviceTagearchusingcustomerno.CustomerNumberTxt.SetText(driver, APOSCustomerNo);
            return serviceTagearchusingcustomerno.AposSearch();
        }
        ...
        {
            new ServiceTagSearchPage(driver).SelectCatalog(catalog);
            var serviceTagearchusingOrderNumber = new ServiceTagSearchPage(driver);
            serviceTagearchusingOrderNumber.OrderNumberTxt.SetText(driver, OrderNumber);
            return serviceTagearchusingOrderNumber.AposSearch();
        }
