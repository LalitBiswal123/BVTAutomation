...
namespace Dsa.Pages
{
    public class SendQuotePage : DsaPageBase
    {
        public SendQuotePage(IWebDriver webDriver)
            : base(webDriver)
        {
...
public IWebElement LnkReturnToQuote { get { return WebDriver.GetElement(By.XPath("//div[@class='next-steps']//a[contains(@href, '#/quote/details/QuoteNumber/')]")); } }
...
public IWebElement ExpirationDateCFO { get { return WebDriver.GetElement(By.XPath("(//table[@class = 'c-data-grid']//tbody/tr/td)[4]")); } }
        ...
        public SendQuotePage SendQuoteViaMail()
        {
            RdbSendQuoteViaFax.Click(WebDriver);
            return this;
        }

        public QuoteDetailsPage SendQuoteCfOEmailtoRecipients(string email, string subject)
        {
        ...
        public SendQuotePage ClearAllQuoteCfoCheckBoxTextBox()
        {
        ...
        public SendQuotePage SendQuoteViaFax()
        {
            RdbSendQuoteViaFax.Click(WebDriver);
            return this;
        }

        public SendQuotePage SendQuote(string sendToEmail = "", bool isDellPrint = true, bool includeMe = false,
            ...
            string additionalComments = "")
        {
            ...
            WebDriverUtil.WaitForElementDisplay(WebDriver, ChkIncludeMeAsRecipient, TimeSpan.FromSeconds(5));
        ...
        public SendQuotePage Sendwithprimarysalesrep(bool primarySalesRep, bool loggedSalesRep, string sendToEmail,
        ...
        public QuoteDetailsPage ReturnToQuoteDetails()
        {
            if (LnkReturnToQuote.IsElementDisplayed(WebDriver))
            {
                LnkReturnToQuote.Click(WebDriver);
            }           
        ...
        public QuoteDetailsPage UpdateSalesRepDetails(string SaleRepName, string SaleRepEmail, string SaleRepPhone,
        ...
        public SendQuotePage DownloadExcelWithPDFFormat(string typeOfAttachment, string sendToEmail, bool isDellPrint,
            bool includeMe, bool cc, bool sendToCustBilling)
        {
            DdlFormat.PickDropdownByText(WebDriver, typeOfAttachment);
